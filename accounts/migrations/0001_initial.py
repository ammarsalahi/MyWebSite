# Generated by Django 4.2 on 2024-07-13 10:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.CharField(max_length=200, verbose_name='')),
                ('university_name', models.CharField(max_length=300, verbose_name='')),
                ('university_web', models.URLField(blank=True, null=True, verbose_name='آدرس دانشگاه')),
                ('socials', models.ManyToManyField(related_name='user_socials', to='accounts.social', verbose_name='')),
